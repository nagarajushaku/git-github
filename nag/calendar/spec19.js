...
describe("login functionality", function() {
    ...
    it("ddsdsdsd",function()
    {
        ...
        browser.driver.sleep(20000);
       element(by.xpath('/html/body/aadhya-root/app-chat-page/div/div/div/div/div/calendar-view/app-calendarbody/div[1]/ng-fullcalendar/div[1]/div[2]/div/button[4]')).click();
         browser.driver.sleep(20000);
