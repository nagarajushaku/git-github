...
// //  browser.waitForAngularEnabled(false)
// element(by.xpath('/html/body/aadhya-root/app-chat-page/div/div/div/div/div/app-weather/div/div/div/div/p[2]')).click();
// browser.driver.sleep(40000);
      //element(by.xpath('/html/body/aadhya-root/app-chat-page/div/div/div/div/div/app-weather/div/div/div')).click();
        // browser.driver.sleep(40000);
