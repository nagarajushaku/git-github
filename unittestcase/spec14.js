...
describe("login functionality", function() {
  ...
  element(by.xpath('//*[@id="default"]/div[1]/ul/li[2]/aadhya-chat-message/div/div/div')).click();
  browser.driver.sleep(6000);
  element(by.xpath('//*[@id="dLabel"]/span')).click();
  browser.driver.sleep(6000);
 element(by.xpath('//*[@id="default"]/div[1]/ul/li[2]/aadhya-chat-message/div/div/div/div[3]/a[2]/ul/li[3]/a')).click();
 //element(by.xpath('//*[@id="default"]/div[1]/ul/li[6]/aadhya-chat-message/div/div/div/div[3]/a[2]/ul/li[3]')).click();
   browser.driver.sleep(6000);
    },1000000);
    //it("aac",function(){
